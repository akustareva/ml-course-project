...
OTHER_OP_WITH_FILE = 'OTHER_OP_WITH_FILE'
CONTROL = 'CONTROL'
...
REG_ROOT = ['HKCR', 'HKCU', 'HKLM', 'HKU', 'HKCC']
EXE_EXT = ['BAT', 'BIN', 'CMD', 'COM', 'EXE', 'GADGET', 'INX', 'ISU', 'JSE', 'MST', 'PAF', 'PS1', 'RGS', 'SCT', 'SHS',
           'VB', 'VBE', 'VBS', 'VBSCRIPT', 'WS', 'WSF']
LIB_EXT = ['DLL', 'LIB']
UNSUCCESSFUL_RESULTS = ['UNSUCCESSFUL', 'END OF FILE', 'NOTIFY ENUM DIR', 'REPARSE', 'ACCESS DENIED', 'CANCELLED',
                        'DELETE PENDING',
                        'FAST IO DISALLOWED', 'FS DRIVER REQUIRED', 'NOT GRANTED', 'NOT IMPLEMENTED',
                        'NOT REPARSE POINT',
                        'OPLOCK NOT GRANTED', 'PRIVILEGE NOT HELD', 'SHARING VIOLATION', 'BAD IMPERSONATION',
                        'BAD NETWORK PATH', 'INVALID DEVICE REQUEST', 'INVALID PARAMETER', 'IS DIRECTORY',
                        'NAME COLLISION',
                        'NAME INVALID', 'NO EAS ON FILE', 'NO MORE ENTRIES', 'NO MORE FILES', 'NO MORE MATCHES',
                        'NO SUCH FILE', 'NOT A DIRECTORY', 'NOT EMPTY', 'CANNOT BREAK OPLOCK', 'CANNOT DELETE',
                        'CANT WAIT',
                        'FILE LOCK CONFLICT', 'FILE LOCKED WITH ONLY READERS', 'FILE LOCKED WITH WRITERS',
                        'OPLOCK HANDLE CLOSED', 'RANGE NOT LOCKED', 'BUFFER OVERFLOW', 'BUFFER TOO SMALL', 'NOT FOUND',
                        'CSC OBJECT PATH NOT FOUND', 'NAME NOT FOUND', 'OBJECTID NOT FOUND', 'PATH NOT FOUND']
